...
const formats = {
  json: {
    codec: () => Promise.resolve().then(function () { return require('./JSONCodec-CRJyWlb_.cjs'); }),
    extension: '.json'
  },
  po: {
    codec: () => Promise.resolve().then(function () { return require('./POCodec-CUEyCCAr.cjs'); }),
    extension: '.po'
  }
};
...
const require$2 = module$1.createRequire((typeof document === 'undefined' ? require('u' + 'rl').pathToFileURL(__filename).href : (_documentCurrentScript && _documentCurrentScript.tagName.toUpperCase() === 'SCRIPT' && _documentCurrentScript.src || new URL('plugin-BqIqNtDr.cjs', document.baseURI).href)));
...
function getCurrentVersion() {
  try {
    const require$1 = module$1.createRequire((typeof document === 'undefined' ? require('u' + 'rl').pathToFileURL(__filename).href : (_documentCurrentScript && _documentCurrentScript.tagName.toUpperCase() === 'SCRIPT' && _documentCurrentScript.src || new URL('plugin-BqIqNtDr.cjs', document.baseURI).href)));
