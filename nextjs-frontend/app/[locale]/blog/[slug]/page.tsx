...
<div className="flex items-center gap-4 pt-8 border-t border-gray-100">
  ...
  <div className="flex items-center gap-3">
    ...
    <a 
      ...
      onClick={(e) => {
        // Fallback: თუ აპლიკაცია არ გაიხსნა 0.5 წამში, გადავიდეს ბრაუზერზე
        setTimeout(() => {
          window.location.href = `https://www.facebook.com/sharer/sharer.php?u=${encodeURIComponent(pageUrl)}`;
        }, 500);
      }}
      target="_blank" 
      rel="noopener noreferrer"
      className="group flex items-center justify-center w-10 h-10 rounded-full border border-gray-200 bg-transparent text-gray-400 hover:bg-[#1877F2] hover:border-[#1877F2] hover:text-white transition-all duration-300 hover:-translate-y-1"
    >
    ...
    {/* X (Twitter) */}
    <a 
      href={`twitter://post?message=${encodeURIComponent(title)}%20${encodeURIComponent(pageUrl)}`}
      onClick={(e) => {
        setTimeout(() => {
          window.location.href = `https://twitter.com/intent/tweet?url=${encodeURIComponent(pageUrl)}&text=${encodeURIComponent(title)}`;
        }, 500);
      }}
      target="_blank" 
      rel="noopener noreferrer"
      className="group flex items-center justify-center w-10 h-10 rounded-full border border-gray-200 bg-transparent text-gray-400 hover:bg-black hover:border-black hover:text-white transition-all duration-300 hover:-translate-y-1"
    >
    ...
    <a 
      ...
      target="_blank" 
      rel="noopener noreferrer"
      className="group flex items-center justify-center w-10 h-10 rounded-full border border-gray-200 bg-transparent text-gray-400 hover:bg-[#0A66C2] hover:border-[#0A66C2] hover:text-white transition-all duration-300 hover:-translate-y-1"
    >
      <svg className="w-5 h-5 fill-current" viewBox="0 0 24 24">
    ...
    <a 
      ...
      target="_blank" 
      rel="noopener noreferrer"
      className="group flex items-center justify-center w-10 h-10 rounded-full border border-gray-200 bg-transparent text-gray-400 hover:bg-[#FF4500] hover:border-[#FF4500] hover:text-white transition-all duration-300 hover:-translate-y-1"
    >
      <svg className="w-5 h-5 fill-current" viewBox="0 0 24 24">
